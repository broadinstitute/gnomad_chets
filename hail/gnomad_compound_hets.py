...
def main(args):
    ...
    if args.write_pairs_kt:
        ...
        (
            ...
            .select(['gene','v1','pass1','impact1','alleleType1','ac1','ac_raw1',
                     'v2','pass2','impact2','alleleType2','ac2','ac_raw2',
                     'sample','pop','prob_same_haplotype'])
    ...
    if args.write_single_kt:
        ...
        (
            kt.annotate(['pop = sa.meta.population','gene = va.gene','impact  = va.impact',
                ...
                .select(['gene','v', 'impact','alleleType','ac_raw','ac','pass','sample', 'pop'])
                .export(
